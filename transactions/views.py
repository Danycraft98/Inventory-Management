...
from .models import (
    Supplier, 
    PurchaseBill, PurchaseItem, PurchaseBillDetails,
...
class SupplierListView(SingleTableMixin, FilterView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        context.update({'title': 'Suppliers', 'btn': 'Add New Supplier', 'link': 'new-supplier'})
        return context
...
class PurchaseView(SingleTableMixin, FilterView):
    model = PurchaseBill
    table_class = PurchaseBillTable
    ...
    def get_context_data(self, *args, **kwargs):
        context = super(PurchaseView, self).get_context_data(*args, **kwargs)
        context.update({'title': 'Purchase', 'btn': 'New Incoming Stock', 'link': 'select-supplier'})
        return context
